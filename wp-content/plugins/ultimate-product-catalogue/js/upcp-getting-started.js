jQuery(document).ready(function() {
	...
	jQuery('.upcp-welcome-screen-add-product-button').on('click', function() {
		...
		var data = 'product_name=' + product_name + '&product_description=' + product_description + '&product_category=' + product_category + '&product_price=' + product_price + '&action=upcp_welcome_add_product';
		jQuery.post(ajaxurl, data, function(response) {
