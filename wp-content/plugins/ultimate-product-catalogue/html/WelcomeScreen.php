...
<div class='upcp-welcome-screen'>
	...
	<div class='upcp-welcome-screen-box upcp-welcome-screen-categories upcp-welcome-screen-open' data-screen='categories'>
		...
		<div class='upcp-welcome-screen-box-content'>
			<p><?php _e('Categories let you organize your products in a way that\'s easy for you - and your customers - to find.', 'ultimate-product-catalogue'); ?></p>
	...
	<div class='upcp-welcome-screen-box upcp-welcome-screen-products' data-screen='products'>
		<h2><?php _e('5. Add Products', 'ultimate-product-catalogue'); ?></h2>
		<div class='upcp-welcome-screen-box-content'>
			<p><?php printf(__('Want more options (product images, sub-categories,  etc)? You can create using the dedicated <a href="%s">dedicated product builder</a> instead.', 'ultimate-product-catalogue'), esc_url('admin.php?page=UPCP-options&Action=UPCP_Add_Product_Screen')); ?></p>
