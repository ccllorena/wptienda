	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br />
				...
				?>
				<?php echo '<a href="https://programadorinformatico.cl" target="_blank" title="' . esc_attr__( 'WooCommerce - The Best eCommerce Platform for WordPress', 'storefront' ) . '" rel="author">' . esc_html__( 'programadorinformatico.cl', 'storefront' ) . '</a>.'; ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
